...
if __name__ == '__main__':
    ...
    TRAIN_DATASET = MyPretrainDataset(data_path, CLASSES, CLASS2SCANS, mode='train',
                                      num_point=2048, pc_attribs='xyzrgbXYZ',
                                      pc_augm=True, pc_augm_config=PC_AUGMENT_CONFIG)